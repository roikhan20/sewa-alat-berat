...
const EQUIPMENT = [
  {
    ...
    capacity: '7.000 kg',
    icon: 'ti-crane',
    specs: ['Max Height: 15.0 m', 'Engine: Kubota Diesel', 'Fuel: Solar', 'Tahun: 2020–2023'],
    desc: 'Ideal untuk pergudangan dan distribusi di area indoor/outdoor.',
  },
  {
    id: 'mobile-crane-25t',
  ...
  },
  {
    ...
    capacity: '5.000 kg',
    icon: 'ti-forklift',
    specs: ['Max Height: 3.3 m', 'Engine: Mitsubishi', 'Fuel: Solar', 'Tahun: 2021–2023'],
    desc: 'Kapasitas tinggi untuk pabrik dan kawasan industri berat.',
  },
  {
    ...
    capacity: '2.500 kg',
    icon: 'ti-forklift',
    specs: ['Max Height: 3.0 m', 'Battery: 48V', 'Zero Emission', 'Tahun: 2022–2024'],
    desc: 'Solusi ramah lingkungan untuk gudang dan cold storage.',
  },
   {
    id: 'crane-25t',
    name: 'Crane 25 Ton',
